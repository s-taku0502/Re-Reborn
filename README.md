...
- 📜 **ミッション機能**: ランダムにミッションを受け取る
- 📸 **写真撮影・保存**: ミッションに従って行動し、写真で記録
...
- **ブラウザ標準 API**: タイムゾーン取得（Intl.DateTimeFormat）。ユーザーのローカルタイムゾーンと現地時間を取得し、明るさレベルを自動判定
...
2. **ミッションを受ける**: ホーム画面から「ミッションを受ける」をタップ
3. **行動する**: 表示されたミッションに従って散歩・行動
